...
module.exports = {
  ...
  sendCustomer: function (options, rfp) {
    var header = `<!DOCTYPE html">
      ...
      if(rfp.salones && rfp.salones.length>0) {
        rfp.salones.forEach(function(salon){
          ...
          <div class="body-element" style="width: 50%;display: inline-block;">
            ...
            <div class="element-value" style="margin: 1em;border-radius: 5px;border: thin solid rgb(181, 181, 181);padding: 0.5em;">`+salon.tipoEvento+`</div>
          </div>
          <div class="body-element" style="width: 49%;display: inline-block;">
            <strong>Montaje</strong><br>
            <div class="element-value" style="margin: 1em;border-radius: 5px;border: thin solid rgb(181, 181, 181);padding: 0.5em;">`+salon.tipoSalon+`</div>
          </div>
          <div class="body-element" style="width: 100%;display: inline-block;">
            <strong>Comentarios adicionales</strong><br>
      ...
      `;
  var htmlfinal = header + datosGrupo + habSencillas + habDobles + datosGrupo1 + header_eventos + eventos1 + hoteles + contacto + close;
...
sendHotel: function (options, rfp, user) {
  var header = `<!DOCTYPE html">
    ...
    `;
  var htmlfinal = header + datosGrupo + habSencillas + habDobles + datosGrupo1 + header_eventos + eventos1 + contacto + close;
  smtpTransport.sendMail({
     from: "Notificación ✔ YoPlanner <grupos@yoplanner.com>",
     to: options.to,
     bcc: "oscarman2001@hotmail.com",
